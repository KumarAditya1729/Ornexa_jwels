...
def main():
    dataset_dir = "/Users/adityashrivastava/Desktop/ORNEXA JEWLS/dataset_cls"
    ...
    results = model.train(
        ...
        name="ornexa_vision",
        exist_ok=True,
        workers=0  # For stability on local mac
    )
    ...
    # Simple confusion matrix: dict of dicts {true_class: {predicted_class: count}}
    ...
    best_model = YOLO("runs/ornexa_vision/weights/best.pt")
    ...
    # Calculate precision and recall macro
    # (Simplified for the output report)
